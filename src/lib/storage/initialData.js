...
export const collections = [
  ...
  "reflections", "quotes", "ideas", "links", "quickLinks", "inboxMemos", "memoPosts", "contentPlans",
  ...
  "moodEntries", "dailyRecords", "monthlyArchives", "studyItems", "studyCaptures", "studyCategories", "studyNotes", "studyCards", "studyExperiments", "studyWorkflows",
...
initialData.studyItems = [
  {
    ...
    status: "not_started",
    priority: "high",
    sourceNote: "콘텐츠에서 AI 검색 최적화 개념으로 들어본 정리가 필요",
    referenceUrls: [],
    uploadUrls: [],
    appliedUrls: [],
    studyNotes: "",
    summary: ["", "", ""],
    applicationIdeas: "",
    nextAction: "관련 글 2개 읽고 블로그 구조에 적용해보기",
    relatedProject: "AI 아이디어",
    revisitDate: today,
    archived: false,
    completedAt: "",
    archiveNote: "",
  ...
  {
    id: "study-item-2",
    title: "AI PPT 콘텐츠 벤치마킹",
    category: "PPT",
    subCategory: "콘텐츠 구조",
    status: "in_progress",
    priority: "normal",
    sourceNote: "인스타에서 AI PPT 콘텐츠 과정을 보고 방향 참고 필요",
    referenceUrls: [],
    uploadUrls: [],
    appliedUrls: [],
    studyNotes: "카드뉴스 구조를 비교해보기",
    summary: ["", "", ""],
    applicationIdeas: "",
    nextAction: "카드뉴스 구조 3개 분석하기",
    relatedProject: "유료PPT",
    revisitDate: today,
    archived: false,
    completedAt: "",
    archiveNote: "",
  ...
  {
    id: "study-item-3",
    title: "랜딩 페이지 가격 섹션 구조",
    category: "브랜드",
    subCategory: "홈페이지",
    status: "apply_pending",
    priority: "high",
    sourceNote: "서비스 가격 안내를 더 예쁘고 쉽게 보여주고 싶음",
    referenceUrls: [],
    uploadUrls: [],
    appliedUrls: [],
    studyNotes: "",
    summary: ["", "", ""],
    applicationIdeas: "가격표 하단 선택 배너로 적용",
    nextAction: "가격표 하단 선택 배너에 적용하기",
    relatedProject: "위스티아",
    revisitDate: today,
    archived: false,
    completedAt: "",
  ...
  {
    id: "study-item-4",
    title: "Supabase 로그인 단순화",
    category: "코딩",
    subCategory: "데이터 연동",
    status: "paused",
    priority: "low",
    sourceNote: "혼자 쓰는 앱이라 복잡한 로그인 없이 관리하고 싶음",
    referenceUrls: [],
    uploadUrls: [],
    appliedUrls: [],
    studyNotes: "",
    summary: ["", "", ""],
    applicationIdeas: "",
    nextAction: "비밀번호 방식과 관리자 모드 비교하기",
    relatedProject: "개인 앱",
